...
public class InstallationEndpointImpl implements InstallationEndpoint{
	
	private static final String PATH = "/installation";
	
	private static final Logger LOG = LoggerFactory.getLogger(InstallationEndpointImpl.class);
	...
	@RequestMapping(value=PATH+"/configure", method = RequestMethod.POST)
	@Override
	...
	@RequestMapping(value=PATH+"/installSchemas", method = RequestMethod.POST)
	@Override
